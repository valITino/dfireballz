...
echo -e "  ${CYAN}/memory-forensics /evidence/memdump.raw${NC}"
echo -e "  ${CYAN}/network-forensics /evidence/capture.pcap${NC}"
echo -e "  ${CYAN}/osint-person suspect@example.com${NC}"
echo -e "  ${CYAN}/osint-domain suspicious-site.com${NC}"
echo -e "  ${CYAN}/incident-response /evidence/compromised-host/${NC}"
echo -e ""
echo -e "  ${BOLD}Quick start:${NC}"
echo -e "  ${CYAN}/mcp${NC}                          ${DIM}Check MCP server status${NC}"
echo -e "  ${CYAN}/complete-investigation /evidence/${NC}  ${DIM}Full 11-phase investigation${NC}"
echo -e "${DIM}──────────────────────────────────────────────────────${NC}"
echo ""
